...
class StorageService:
    ...
    async def store_file(self, content: bytes, filename: str, dataset_id: str = None) -> Dict[str, Any]:
        ...
        return {"dataset_id": dataset_id, "local_path": str(path), "size_bytes": len(content)}
